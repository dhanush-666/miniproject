<?php 
  ...
  class PDF extends FPDF
  {
    function Header(){
      ...
      $this->Cell(50,10,"shakthie murugan bule metals ",0,1);
      $this->SetFont('Arial','',14);
      $this->Cell(50,7,"kangayam 638701.",0,1);
      $this->Cell(50,7,"PH : 9940716266",0,1);
    ...
    function Footer(){
      ...
      $this->SetY(-50);
      $this->SetFont('Arial','B',12);
      $this->Cell(0,10,"for shakthie murugan bule metals",0,1,"R");
      $this->Ln(15);
      $this->SetFont('Arial','',12);
